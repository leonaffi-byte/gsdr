...
<purpose>
Research how to implement a phase. Spawns gsdr-phase-researcher with phase context.
...
@${CLAUDE_SKILL_DIR}/../references/model-profile-resolution.md
...
@${CLAUDE_SKILL_DIR}/../references/phase-argument-parsing.md

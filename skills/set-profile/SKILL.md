...
<purpose>
Switch the model profile used by GSDR agents. Controls which Claude model each agent uses, balancing quality vs token spend.
</purpose>
...
[Show table from MODEL_PROFILES in gsdr-tools.cjs for selected profile]

Example:
| Agent | Model |
|-------|-------|
| gsdr-planner | opus |
| gsdr-executor | sonnet |
| gsdr-verifier | haiku |
| ... | ... |

...
- This section feeds directly into /gsdr:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /gsdr:plan-phase --gaps with root causes
...
**Creation:** When /gsdr:verify-work starts new session

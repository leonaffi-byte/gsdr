...
Template for spawning gsdr-debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
```python
Task(prompt=template, subagent_type="gsdr-debugger", description="Debug UAT-001")
```

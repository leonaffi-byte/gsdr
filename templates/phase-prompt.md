...
<execution_context>
@${CLAUDE_SKILL_DIR}/../workflows/execute-plan.md
...
<!-- For checkpoint task examples and patterns, see @${CLAUDE_SKILL_DIR}/../references/checkpoints.md -->
...
See `${CLAUDE_SKILL_DIR}/../references/tdd.md` for TDD plan structure.
...
See `${CLAUDE_SKILL_DIR}/../templates/user-setup.md` for full schema and examples
...
See `${CLAUDE_SKILL_DIR}/../workflows/verify-phase.md` for verification logic.
